...
class Order {
    ...
    public Order(int id, String services, int price) {
        this.id = id;
    ...
    public void printOrder() {
        System.out.println("Подписка #" + id + ": " + services + ", цена: " + price);
    }
}
...
class Subscription extends Order {
    ...
    public Subscription(int id, String services, int price, LocalDate startDate, LocalDate endDate, List<DayOfWeek> daysOfWeek) {
        super(id, services, price);
        this.startDate = startDate;
        this.endDate = endDate;
        this.daysOfWeek = daysOfWeek;
    }

    public void extendSubscription(int extraDays) {
        endDate = endDate.plusDays(extraDays);
        System.out.println("Подписка #" + id + " продлена до " + endDate);
    }
    ...
    public void printOrder() {
        System.out.println("Подписка #" + id + ": " + services + ", цена: " + price +
                ", с " + startDate + " по " + endDate + ", дни: " + daysOfWeek);
    }
}
...
public class Main {
    public static void main(String[] args) {
        ...
        List<DayOfWeek> gymDays = new ArrayList<>();
        gymDays.add(DayOfWeek.MONDAY);
        gymDays.add(DayOfWeek.WEDNESDAY);
        gymDays.add(DayOfWeek.FRIDAY);
        ...
        List<DayOfWeek> netflixDays = new ArrayList<>();
        ...
        for (Order sub : subscriptions) {
            sub.printOrder();
        }

        s1.extendSubscription(7);
        s1.recalcPrice(500);
        s1.printOrder();

        s2.extendSubscription(10);
        s2.recalcPrice(300);
        s2.printOrder();
    }
}